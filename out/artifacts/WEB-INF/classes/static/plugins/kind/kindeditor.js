...
K.options = {
	...
	items : [
		...
		'selectall','cut', 'copy', 'paste','plainpaste','clearhtml', '|',
		
		'undo', 'redo','|',
		
		 'about','code','source','preview',
		...
		'image','emoticons','table', 'link', 'unlink'
...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	...
	_each(cssPath, function(i, path) {
		if (path) {
			arr.push('<link href="../../edit/kindeditor/' + path + '" rel="stylesheet" />');
		}
	});
	if (cssData) {
...
_extend(KUploadButton, {
	init : function(options) {
		...
		var html = [
			...
			(options.form ? '<div class="ke-upload-area">' : '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + target + '" action="../../edit/kindeditor/' + url + '">'),
...
_plugin('core', function(K) {
	...
	self.clickToolbar('about', function() {
		var html = '<div style="margin:20px;">' +
			...
			'<div>Copyright © <a href="http://www.kindsoft.net/" target="_blank">kindsoft.net</a> jsall rights reserved.</div>' +
			'</div>';
		self.createDialog({
			name : 'about',
			width : 300,
	...
	self.beforeSetHtml(function(html) {
		...
		.replace(/<a[^>]*name="([^"]+)"[^>]*>(?:<\/a>)?/ig, function(full) {
			...
			return '<img class="ke-anchor" src="../../edit/kindeditor/' + self.themesPath + 'common/anchor.gif" data-ke-name="' + escape(attrs.name) + '" />';
		})
