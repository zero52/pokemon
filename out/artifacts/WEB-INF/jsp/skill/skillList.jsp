    ...
    <div class="g1cnt cf">
        ...
        <form class="g1form rel z3 mt15 cf b bgw2 r" method="" action="">
            <ul class="fib tkz6 fb2 fz2 cf">
                ...
                <li>
                    <label>名称：</label>
                    <input class="ipu ipua w9 r" placeholder="名称" name="name" type="text"/>
                </li>
                <li>
                    <label>属性：</label>
                    <input class="ipu ipua w9 r" placeholder="属性" name="type" type="text"/>
                </li>


                <li>
                    <label>分类：</label>
                    <input class="ipu ipua w9 r" placeholder="分类" name="category" type="text"/>
                </li>
        ...
        <div class="g1mod mt6">
            <h3 class="g1mh imh imh12">技能列表</h3>
            <div class="cotb mt15 tb6bb0">
                <table class="tb6">
                    ...
                    <c:forEach items="${list}" var="list">
                        <tr>
                            <td title="${list.effect}">${list.name}</td>
                            <td>
                                    ${list.type}
                            </td>
                            <td>${list.category}</td>
